        ...
        <div className="flex flex-col items-center text-center space-y-4">
          ...
          <div className="space-y-1">
            ...
            <p className="text-sm font-medium text-zinc-500 dark:text-zinc-400">
              Create your collector profile to contribute
            </p>
          </div>
        </div>
        ...
        <div className="rounded-[2.5rem] bg-white p-10 shadow-2xl shadow-zinc-200/50 dark:bg-zinc-900 dark:shadow-none border border-zinc-100 dark:border-zinc-800">
          <form className="space-y-6" onSubmit={handleSubmit}>
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="flex w-full items-center justify-center gap-2 rounded-2xl bg-black px-4 py-4 text-xs font-black uppercase tracking-[0.2em] text-white transition-all hover:bg-zinc-800 disabled:bg-zinc-200 dark:bg-white dark:text-black dark:hover:bg-zinc-200 dark:disabled:bg-zinc-800 dark:disabled:text-zinc-600"
            >
              {isLoading ? (
          ...
          <div className="mt-8 text-center">
            <p className="text-xs font-bold uppercase tracking-widest text-zinc-400">
              Already a Member?{" "}
              <Link href="/login" className="text-zinc-900 underline underline-offset-4 hover:text-zinc-600 dark:text-white dark:hover:text-zinc-400 transition-colors">
                Sign In
              </Link>
            </p>
          </div>
