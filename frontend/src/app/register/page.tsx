    ...
    <div className="flex min-h-screen items-center justify-center bg-[#FAFAFA] px-6">
      <div className="w-full max-w-100">
        <div className="mb-12">
          ...
          <h2 className="text-2xl font-medium tracking-tight text-zinc-900 mt-2">Create your account.</h2>
        </div>
        ...
        <form className="space-y-6" onSubmit={handleSubmit}>
          ...
          >
            {isLoading ? <Loader2 className="animate-spin" size={14} /> : "Initialize Profile"}
