    ...
    <div className="max-w-5xl mx-auto py-12 px-6">
      ...
      <header className="mb-10">
        ...
        <p className="text-zinc-500 mt-2 font-medium">
          Updating record for:{" "}
          <span className="font-mono text-xs bg-zinc-100 dark:bg-zinc-900 px-2 py-1 rounded-md">
            {slug}
          </span>
        </p>
      </header>
      ...
      {loading ? (
        ...
        <div className="flex flex-col items-center justify-center py-32 bg-red-50/50 dark:bg-red-900/5 border border-red-100 dark:border-red-900/20 rounded-[3rem]">
          ...
          <Link
            href="/admin"
            className="mt-6 text-xs font-black uppercase underline underline-offset-4"
          >
            Return to Safety
          </Link>
        </div>
